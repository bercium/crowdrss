...
class CronController extends Controller {
    ...
    public function actionPoolCrowd($platforms = '') {
        ...
        if ($platforms == '' || in_array("ulule", $platforms_array)) echo $this->consoleCommand('update', 'ulule');
        ...
        if ($platforms == '' || in_array("crowdfunder", $platforms_array)) echo $this->consoleCommand('update', 'crowdfunder');
