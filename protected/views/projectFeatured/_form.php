...
?>
	...
	<?php echo $form->errorSummary($model); ?>
		...
		<?php echo $form->dropDownList($model, 'project_id', GxHtml::listDataEx(Project::model()->findAllAttributes(null, true," time_added > DATE_ADD(NOW(),INTERVAL -8 DAY) ORDER BY id DESC"))); ?>
