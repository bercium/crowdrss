...
<div class="row header-margin">
    ...
    <div class="columns panel edit-content">
        ...
        <div class="row">
          <div class="columns medium-6 description">
            <?php echo CHtml::beginForm(Yii::app()->createUrl('statistic/database'),'post',array("class"=>"","id"=>"form_db_execute")); ?>
            ...
            <div id="graphForm" class=" <?php if ($model->graph == '') echo 'hide'; ?>">
          ...
          <div class="columns medium-6">
            ...
            foreach($tables as $tbl){
                echo '<span title="<strong>'.$tbl->name."</strong><br /><br />".implode('<br /> ', $tbl->columnNames).'" class="label" style="margin:1px" data-tooltip>'.$tbl->name."</span> ";
            }
             ?>
          </div>
