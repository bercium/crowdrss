      ...
      <div class="row">
        ...
        <div class="columns medium-6 social">
          <br />
            ...
            <a trk="social_twitter_share_bottom" href="https://twitter.com/tweet/intent?url=<?php echo Yii::app()->params['absoluteHost']; ?>&text=<?php echo $this->pageTitle; ?>" data-hashtags="crowdfunding,kickstarter"  target="_none" ><img style="height:80px" src="<?php echo Yii::app()->request->baseUrl; ?>/images/tww.png" data-tooltip data-options="disable_for_touch:true" class="tip-right radius" title="Tweet about us"></a>
