...
<div class="pb60 pt40">
  <div class="row">
    <div class="columns medium-12">
        ...
        <p class="mb30">
          Each share helps our quest in becoming the best crowdfunding digest site. <strong>And it helps you gain points as well! ;)</strong>
        </p>    
        <div class="progress" style="height:15px;">
            <span class="meter progress-meter success"></span>
            <?php /* ?><span class="meter progress-meter-invert alert"></span><?php */ ?>
        </div>
        <div class="mt20"></div>
            
        <ul class="small-block-grid-2 medium-block-grid-4 large-block-grid-4">
            <li class="relative">
                <div class="facebook social-ok hide">
