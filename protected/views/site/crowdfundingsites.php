    ...
    <div class="columns medium-9">
        ...
        */
        ...
        foreach ($sites as $site) {
            ...
            <li>
                <img src="<?php echo getLinkIcon($site['link']); ?>"> <a href="<?php echo $site['link']; ?>" target="_blank"  data-tooltip aria-haspopup="true" class="" title="<?php echo $site['title']; if($site['keywords']) echo "<br /><strong>Keywords: </strong>".$site['keywords']; ?>"><?php echo trim_text($site['title'],20); ?></a>
