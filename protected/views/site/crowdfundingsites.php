    ...
    <div class="columns medium-3">
        <ul class="side-nav" role="navigation" title="Link List">
            ...
            <?php foreach ($categories as $cat) {?>
                <li role="menuitem"><a href="<?php echo Yii::app()->createUrl("crowdfunding-sites/".$cat['category']); ?>"><?php echo $cat['category']; ?></a></li>
            <?php } ?>
        </ul>
    </div>
    <div class="columns medium-9">
        ...
        */
        ...
        foreach ($sites as $site) {
            ...
            <li><img src="<?php echo getLinkIcon($site['link']); ?>"> <a href="<?php echo $site['link']; ?>" target="_blank"><?php echo $site['title']; ?></a></li>
